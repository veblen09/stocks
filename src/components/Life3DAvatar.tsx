...
export const Life3DAvatar: React.FC = () => {
  ...
  if (currentAge >= 65) {
    ...
    stageDesc = '자녀 독립 후 부부의 은퇴가 임박한 시기로, 자산을 안전자산 및 개인연금(IRP) 위주로 안정되게 재배분하여 노후를 대비합니다.';
  } else if (currentAge >= 45) {
    stageTitle = '가족 재무관리 (40대~50대)';
    stageDesc = '성장한 첫째와 둘째 자녀의 학령기 교육비 및 생활비가 집중되는 시기로, 소득 피크에 맞춘 빈틈없는 지출 통제와 자산 관리가 필요합니다.';
