...
1. **실제 역사적 시장 데이터 100% 기반 (No Random / No Fabricated Data)**
   - 한국 30개 종목(KRX 우량주 및 한보철강·제일은행·대우·팬택·LG 등) + 미국 30개 대표 종목(S&P 500/Nasdaq 및 리만브라더스·엔론·블랙베리·블록버스터·노키아 등) = **총 60개 역사적 종목 수록**
   - 1980년 말부터 2025년 말까지 46개 연말 시점, 45개 연간 운용 구간의 실제 수정주가 및 배당 재투자 총수익률(Total Return) 반영
   - **생존자 편향(Survivorship Bias) 방지**: 한때 시장을 호령하다 상장폐지/몰락한 기업들을 탑재하여 현실적인 리스크 관리 체감
